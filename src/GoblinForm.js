...
export default function GoblinForm({ setGoblinFormName, setGoblinFormHP, setGoblinFormColor }) {
  return (
    <div className='goblin-form-container quarter'>
      ...
      <form className='goblin-form'>
        <label>
          ...
          <input required onChange={e => setGoblinFormName(e.target.value)} value={props.goblinFormName} />
        ...
        <label>
          ...
          <input required onChange={e => setGoblinFormHP(e.target.value)} type="number" value={props.goblinFormHP} />
          {/* note that we're controlling the input's value from parent state */}
        </label>
        <label>
            Color
          {/* onChange, use the prop setGoblinFormColor to set the parent state */}
          <select required onChange={e => setGoblinFormColor(e.target.value)} value={props.goblinFormColor}>
            {/* note that we're controlling the input's value from parent state */}
